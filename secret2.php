...
<html>
<style>
body {font-family: helvetica; font-size: 20px; text-align: center; background-color:#E0FDFF;}
text {font-family: helvetica; font-size: 15px; background-color:#E0FDFF;}
</style>
...
Something you would like to share? <br>
